...
def get_sales_data():
    ...
    from the user via the terminal, which must be a 
    string of 6 numbers, separated by commas.  The loop
...
def main():
    ...
    stock_data = get_last_sales_data(sales_columns)
